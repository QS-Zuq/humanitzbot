...
const ENV_CATEGORIES = [
  ...
  },
  {
    ...
    label: 'Module Toggles 3',
    emoji: '⚡',
    group: 1,
    description: 'Additional module toggles (restart required)',
    restart: true,
    fields: [
  ...
  {
    id: 'features_advanced2',
    label: 'Module Toggles 4',
    emoji: '⚡',
    group: 1,
    description: 'More module toggles (restart required)',
    restart: true,
    fields: [
  ...
  {
    id: 'server_advanced2',
    label: 'Server Advanced 2',
    emoji: '🖥️',
    group: 1,
    description: 'HZMod status, extra channels (restart required)',
    restart: true,
    fields: [
  ...
  {
    id: 'display_missing2',
    label: 'Display: More 2',
    emoji: '📊',
    group: 2,
    description: 'Skills and world stats toggles (applies live)',
    restart: false,
    fields: [
      {
...
const ENV_CATEGORY_GROUPS = [
  ...
  },
  {
    id: 'tracking',
    icon: 'line-chart',
    categories: ['activity_feeds', 'activity_feeds2', 'activity_log', 'log_features'],
  },
  {
    id: 'display',
    icon: 'monitor',
