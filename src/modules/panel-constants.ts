...
const ENV_CATEGORIES = [
  ...
  },
  {
    ...
    fields: [
      ...
      { env: 'ADMIN_ALERT_CHANNEL_IDS', label: 'Alert Channel IDs (comma-sep)', cfg: 'adminAlertChannelIds' },
      { env: 'ADMIN_VIEW_PERMISSIONS', label: 'Admin View Perms (e.g. Administrator)', cfg: 'adminViewPermissions' },
    ],
  },
  {
    id: 'credentials',
    ...
    fields: [
      ...
      { env: 'RCON_PASSWORD', label: 'RCON Password', cfg: 'rconPassword', sensitive: true },
      { env: 'PANEL_SERVER_URL', label: 'Panel Server URL', cfg: 'panelServerUrl' },
      { env: 'PANEL_API_KEY', label: 'Panel API Key', cfg: 'panelApiKey', sensitive: true },
    ],
  },
  {
    id: 'sftp',
  ...
  },
  {
    ...
    emoji: '🤖',
    group: 1,
    description: 'Remote save-parser agent (timing applies live; mode/paths require reconnect)',
    restart: true,
    reloadStrategy: 'connection-reconnect',
    fields: [
      ...
      { env: 'AGENT_TRIGGER', label: 'Trigger (auto/ssh/panel/none)', cfg: 'agentTrigger' },
      {
        ...
        label: 'Agent Poll Interval (ms)',
        cfg: 'agentPollInterval',
        type: 'int',
        reloadStrategy: 'module-reconfigure',
      },
      {
  ...
  },
  {
    ...
    fields: [
      ...
      { env: 'ENABLE_ANTICHEAT', label: 'Anticheat (true/false)', cfg: 'enableAnticheat', type: 'bool' },
      {
        ...
        cfg: 'enableServerScheduler',
        type: 'bool',
      },
      { env: 'ENABLE_DID_YOU_KNOW', label: 'Did You Know (true/false)', cfg: 'enableDidYouKnow', type: 'bool' },
      { env: 'ENABLE_PLAYER_CARDS', label: 'Player Cards (true/false)', cfg: 'enablePlayerCards', type: 'bool' },
      { env: 'ENABLE_NEWSPAPER', label: 'Newspaper (true/false)', cfg: 'enableNewspaper', type: 'bool' },
      { env: 'ENABLE_HOWYAGARN', label: 'Howyagarn (true/false)', cfg: 'enableHowyagarn', type: 'bool' },
      { env: 'ENABLE_CHALLENGE_FEED', label: 'Challenge Feed (true/false)', cfg: 'enableChallengeFeed', type: 'bool' },
    ],
  },
  {
    id: 'automsg',
  ...
  },
  {
    ...
    fields: [
      ...
      { env: 'SAVE_POLL_INTERVAL', label: 'Direct Save Poll (ms)', cfg: 'savePollInterval', type: 'int' },
  ...
  },
  {
    ...
    fields: [
      ...
      { env: 'PVP_DAYS', label: 'Days (e.g. Mon,Wed,Fri)', cfg: 'pvpDays' },
    ],
  },
  {
    id: 'pvp_hours',
    label: 'PvP Hours & Overrides',
    emoji: '📅',
    group: 2,
    ...
    fields: [
      ...
      { env: 'PVP_HOURS_WED', label: 'Wednesday (HH:MM-HH:MM)', cfg: 'pvpHoursWed' },
      { env: 'PVP_HOURS_THU', label: 'Thursday (HH:MM-HH:MM)', cfg: 'pvpHoursThu' },
      { env: 'PVP_HOURS_FRI', label: 'Friday (HH:MM-HH:MM)', cfg: 'pvpHoursFri' },
      { env: 'PVP_HOURS_SAT', label: 'Saturday (HH:MM-HH:MM)', cfg: 'pvpHoursSat' },
      { env: 'PVP_HOURS_SUN', label: 'Sunday (HH:MM-HH:MM)', cfg: 'pvpHoursSun' },
      {
        env: 'PVP_SETTINGS_OVERRIDES',
        label: 'Settings Override JSON',
        cfg: 'pvpSettingsOverrides',
        style: 'paragraph',
      },
    ],
  },
  // ── Group 1: Additional Core & Module Settings ─────────────
  {
    id: 'locale_console',
    ...
    fields: [
      ...
      {
        env: 'STDIN_CONSOLE_WRITABLE',
        label: 'Console Writable (true/false)',
        cfg: 'stdinConsoleWritable',
        type: 'bool',
      },
    ],
  },
    ...
    fields: [
      {
        ...
        cfg: 'anticheatAnalyzeInterval',
        type: 'int',
      },
      {
        env: 'ANTICHEAT_BASELINE_INTERVAL',
        label: 'Baseline Interval (ms)',
        cfg: 'anticheatBaselineInterval',
        type: 'int',
      },
    ],
  },
  {
    ...
    fields: [
      ...
      { env: 'AGENT_PANEL_COMMAND', label: 'Panel Command', cfg: 'agentPanelCommand' },
      { env: 'AGENT_PANEL_DELAY', label: 'Panel Delay (ms)', cfg: 'agentPanelDelay', type: 'int' },
    ],
  },
  {
    id: 'restart_schedule',
    ...
    fields: [
      ...
      { env: 'RESTART_DELAY', label: 'Countdown (min)', cfg: 'restartDelay', type: 'int' },
      { env: 'RESTART_ROTATE_DAILY', label: 'Rotate Daily (true/false)', cfg: 'restartRotateDaily', type: 'bool' },
      { env: 'SERVER_NAME_TEMPLATE', label: 'Name Template', cfg: 'serverNameTemplate' },
    ],
  },
  {
    id: 'server_advanced',
    ...
    fields: [
      ...
      { env: 'HZMOD_SERVER_ID', label: 'HZMod Server ID', cfg: 'hzmodServerId' },
      { env: 'HZMOD_SOCKET_PATH', label: 'HZMod Socket Path', cfg: 'hzmodSocketPath' },
      { env: 'HZMOD_STATUS_PATH', label: 'HZMod Status Path', cfg: 'hzmodStatusPath' },
      { env: 'ACTIVITY_LOG_CHANNEL_ID', label: 'Activity Log Channel', cfg: 'activityLogChannelId' },
      { env: 'HOWYAGARN_CHANNEL_ID', label: 'Howyagarn Channel', cfg: 'howyagarnChannelId' },
    ],
  },
  // ── Group 2: Additional Display Settings ────────────────────
  {
    id: 'display_missing',
    label: 'Display: More',
    emoji: '📊',
    ...
    fields: [
      {
        ...
        label: 'Inv Log Admin-Only (true/false)',
        cfg: 'showInventoryLogAdminOnly',
        type: 'bool',
      },
      { env: 'SHOW_CONTAINERS', label: 'Containers (true/false)', cfg: 'showContainers', type: 'bool' },
      {
        env: 'SHOW_CONTAINERS_ADMIN_ONLY',
        label: 'Containers Admin-Only (true/false)',
        cfg: 'showContainersAdminOnly',
        type: 'bool',
      },
      { env: 'SHOW_HORSES', label: 'Horses (true/false)', cfg: 'showHorses', type: 'bool' },
      {
        env: 'SHOW_HORSES_ADMIN_ONLY',
        label: 'Horses Admin-Only (true/false)',
        cfg: 'showHorsesAdminOnly',
        type: 'bool',
      },
      {
        env: 'SHOW_SKILLS_ADMIN_ONLY',
        label: 'Skills Admin-Only (true/false)',
        cfg: 'showSkillsAdminOnly',
        type: 'bool',
      },
      { env: 'SHOW_WORLD_STATS', label: 'World Stats (true/false)', cfg: 'showWorldStats', type: 'bool' },
    ],
  },
  {
    id: 'session',
...
const ENV_CATEGORY_GROUPS = [
  {
    id: 'core',
    icon: 'server',
    categories: ['server_identity', 'channels', 'admin', 'locale_console', 'timezone'],
  },
  {
    id: 'connection',
    icon: 'plug',
    categories: ['credentials', 'sftp', 'sftp_paths', 'agent', 'agent_advanced', 'server_advanced', 'session'],
  },
  {
    id: 'features',
    icon: 'toggle-right',
    categories: ['features', 'anticheat_config'],
  },
  {
    id: 'automation',
    icon: 'calendar-clock',
  ...
  },
  {
    id: 'tracking',
    icon: 'line-chart',
    categories: ['activity_feeds', 'activity_log', 'log_features'],
  },
  {
    id: 'player_display',
    icon: 'user',
    categories: ['display_player', 'sub_vitals', 'sub_status', 'sub_inventory', 'sub_misc', 'sub_access'],
  },
  {
    id: 'panel_display',
    icon: 'monitor',
  ...
  },
  {
    ...
    categories: ['intervals', 'advanced', 'threads_misc'],
  },
];
