...
// ═════════════════════════════════════════════════════════════════════
async function _checkDayRollover() {
 ...
 * @returns {object|null}
 */
function getRecentContainerAccess(actorName) {
 ...
 */
async function sendToDateThread(embed, dateStr) {
  const today = this._config.getToday();
